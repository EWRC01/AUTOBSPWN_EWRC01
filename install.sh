...
#Instalamos dependencias iniciales
sudo apt install -y build-essential git vim xcb libxcb-util0-dev libxcb-ewmh-dev libxcb-randr0-dev libxcb-icccm4-dev libxcb-keysyms1-dev libxcb-xinerama0-dev libasound2-dev libxcb-xtest0-dev libxcb-shape0-dev

#Instalamos requerimientos de la polybar
sudo apt install -y cmake cmake-data pkg-config python3-sphinx libcairo2-dev libxcb1-dev libxcb-util0-dev libxcb-randr0-dev libxcb-composite0-dev python3-xcbgen xcb-proto libxcb-image0-dev libxcb-ewmh-dev libxcb-icccm4-dev libxcb-xkb-dev libxcb-xrm-dev libxcb-cursor-dev libasound2-dev libpulse-dev libjsoncpp-dev libmpdclient-dev libuv1-dev libnl-genl-3-dev

#Instalamos requerimientos y dependencias de picom
...
#Creamos la carpeta de repositorios

mkdir ~/github

#Descargamos los repositorios de la polybar y Picom
cd ~/github
git clone --recursive https://github.com/polybar/polybar
git clone https://github.com/ibhagwan/picom.git

#Hacemos la instalacion de la polybar
cd ~/github/polybar
mkdir build
cd build
cmake ..
...
#Hacemos la instalacion de picom
cd ~/github/picom
...
#Instalamos el tema para la  zsh powerlevel10k
git clone --depth=1 https://github.com/romkatv/powerlevel10k.git ~/.powerlevel10k
echo 'source ~/.powerlevel10k/powerlevel10k.zsh-theme' >>~/.zshrc

#Instalamos el tema powerlevel10k para root
...
#Copia de configuracion de p.10.zsh y .zshrc
rm -rf ~/.zshrc
...
notify-send "BSPWM INSTALADO CON EXITO SIGUEME COMO @EWRC01"
